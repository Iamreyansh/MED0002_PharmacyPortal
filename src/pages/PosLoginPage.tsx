...
import { applyTokenPair } from '@/api/token-store';
import { loginErrorCopy } from '@/auth/errors';
import { isUuid } from '@/auth/identifier';
...
function readLastIds(): { pharmacyId: string; staffId: string } {
  try {
    ...
    const parsed = JSON.parse(raw) as { pharmacyId?: unknown; staffId?: unknown };
    return {
    ...
    <section className="page auth-page" data-testid="pos-login-page">
      ...
      <form className="auth-form" onSubmit={onSubmit} noValidate>
        ...
        <fieldset className="pin-field">
          <legend>PIN</legend>
          <p className="pin-display" aria-live="polite" data-testid="pin-display">
